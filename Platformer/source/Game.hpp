...
{
	///////////// инициализация ///////////////////////////
	RenderWindow window(VideoMode(1920, 1080), "The Game!", Style::Fullscreen);  // Инициализация окна (открытие в полноэкранном режиме)
	View view(FloatRect(0, 0, 450, 280));

	Level lvl;
	lvl.LoadFromFile("files/Level1.tmx");  // Загружаем карту из XML файла
	...
	anim.loadFromXML("files/anim_adventurer.xml", adventurer);  // Загружаем анимации игрока из файла XML
	...
	/// Создаем анимации для врагов и платформ///
